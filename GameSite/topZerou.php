...
<meta charset="utf-8">
    ...
    <h2 class="d-flex justify-content-center"><b>Zerou Mais Vezes O Jogo<b></h2>
    </div>
...
<div class="">
            ...
            <tr class=''>
                ...
                <th class="first" width="30%">Vezes Que Zerou</th>
            </tr>
            </table>
...
$result3 = mysqli_query($conn, "SELECT *  FROM estatisticas ORDER BY VezesZerou DESC LIMIT 10 OFFSET $comeco");
...
if (mysqli_num_rows($result2) ) {
    while ($row2 = mysqli_fetch_array($result3)) {
        ...
        <td width='30%' style='cursor: context-menu;'>{$row2['VezesZerou']}</td>
        </tr>
        ";
        $nivel ++;
        $colunas ++;
